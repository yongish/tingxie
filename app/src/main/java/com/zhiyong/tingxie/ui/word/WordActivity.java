...
//                                    pinyin = new Util().lookupPinyin(inputWord);
                  ...
                  if (pinyin != null && pinyin.length() > 0) {
                    ...
                    // in Kotlin.
//                                        mWordViewModel.updateQuiz(new Quiz(quizItem
//                                        .getId(), quizItem.getDate(), quizItem
//                                        .getTitle(), totalWords, totalWords, 1));
                  } else {
                    Toast.makeText(WordActivity.this,
    ...
    mWordViewModel.getWordItemsOfQuizStatus().observe(this, wordItemsStatus -> {
      switch (wordItemsStatus) {
        ...
        case ERROR_CREATE:
          Toast.makeText(
              this,
              "Error in creating a word. Check your Internet connection or email " +
        ...
        case ERROR_DELETE:
          Toast.makeText(
              this,
              "Error in deleting a word. Check your Internet connection or email " +
                  "yongish@gmail.com for help.",
              Toast.LENGTH_LONG
          ).show();
          break;
