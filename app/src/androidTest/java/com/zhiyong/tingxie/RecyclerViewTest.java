...
public class RecyclerViewTest {
    ...
    @Before
    public void before() {
        InstrumentationRegistry.getContext().deleteDatabase("pinyin_database");
    }

    @Test
    public void addSingleQuiz() {
        InstrumentationRegistry.getContext().deleteDatabase("pinyin_database");
        ...
        onView(withId(R.id.recyclerview_main))
                .check(matches(atPosition(0, hasDescendant(withText(containsString("Wed, 01 Jan 2020"))))));
    }
